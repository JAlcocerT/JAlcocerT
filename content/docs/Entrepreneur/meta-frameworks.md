...
As entrepreneur, you better [ask questions](https://jalcocert.github.io/JAlcocerT/questions-for-engineers/).

All day.

And get proefficient at it, because the quality of the replies is limited by the qality of the questions.

## Communication Patterns

Stop moving information and adding some noise in the process.

Start driving outcomes across teams, programs, and the broader organization.

I put together a detailed framework in [this blog section](https://jalcocert.github.io/JAlcocerT/selfhosting-data-analytics/#six-stakeholder-communication-patterns)
...
{{< details title="Fwk details 📌" closed="true" >}}
