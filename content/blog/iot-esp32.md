...
tags: ["IoT x Arduino-CLI","TP4056 x DW01A x 18650","Velxio"]
...
1. Sending DHT11 Data to Arduino Cloud

You can create an account: `https://cloud.arduino.cc/home/` [like so](https://www.youtube.com/watch?v=rcCxGcRwCVk)
...
ESP32 GPIO pins in real-time with AWS API Gateway WebSockets [like so](https://www.youtube.com/watch?v=z53MkVFOnIo)
...
Publish sample data (from the RPi to the Rpi) [like so](https://github.com/jiteshsaini/mqtt-demo/blob/main/rpi_mqtt_clients/client_pub.py)
...
So this is it from the Setup side.

Now choose the IoT Project you want to have running and execute just one more command.

**IoT Projects with Ansible** The Mongo Project
...
You also have: **The Influx Project**
