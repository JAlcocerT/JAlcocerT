...
3. Combine those with modern AI tools like [Perplexity spaces](https://www.perplexity.ai/spaces/templates): `https://www.perplexity.ai/spaces/yc-startup-advisor` or h`ttps://www.perplexity.ai/spaces/build-best-in-class-yIy36UyQRCKzRt_L3NnWlw`
...
{{< cards cols="2" >}}
  {{< card link="https://www.amazon.es/sendtokindle" title="Send to Kindle | Amazon ↗" >}}
  {{< card link="https://jalcocert.github.io/JAlcocerT/kindle-clippings-knowledge-base/" title="Creating ebook as code 101 | Post ↗" >}}
{{< /cards >}}

{{< cards >}}
  {{< card link="https://github.com/JAlcocerT/ebook-ideas" title="eBook Ideas" image="/blog_img/apps/gh-jalcocert.svg" subtitle="Gathering sources - Shipping ebooks - Source Code on Github" >}}
{{< /cards >}}

See how to [create a ebook ideas repo](#https://jalcocert.github.io/JAlcocerT/social-signin-101/#how-to-create-an-slidev-editor)
...
> Go to `https://github.com/login/device` and approve.
...
#git init && git add . && git commit -m "Initial commit: Starting ebook_ideas repo with concepts" && gh repo create ebook-ideas --private --source=. --remote=origin --push
```
