...
And to not [capture emails](#talks-x-emails)?
 ...
 1. Generate SSH key:
  ...
  Alternative if stuck with HTTPS: store credentials locally.
  git config --global credential.helper wincred
  First push/pull asks password once, then cached. Less secure than SSH but works.

  Which instance — gitlab.com or self-hosted?
