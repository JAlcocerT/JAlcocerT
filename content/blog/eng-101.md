...
The [3 body problem](https://jalcocert.github.io/JAlcocerT/ai-scripts-and-animated-data/#the-3-body-problem) has sth to say about that:

$$\ddot{\vec{r}}_1 = -G m_2 \frac{\vec{r}_1 - \vec{r}_2}{|\vec{r}_1 - \vec{r}_2|^3} - G m_3 \frac{\vec{r}_1 - \vec{r}_3}{|\vec{r}_1 - \vec{r}_3|^3}$$

Just with some math, you form [equations of motion](https://jalcocert.github.io/JAlcocerT/about-constrained-mechanism/#equations-of-motion-what-they-are-and-how-to-solve-them):
...
Luckily Ive had a come back to this topic: https://github.com/JAlcocerT/mbsd-core
...
{{< details title="ELRS x LoRa 📌" closed="true" >}}
