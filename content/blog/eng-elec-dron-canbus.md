...
At $6.4\text{V}$, the internal cells sit around $3.2\text{V}$ each, which is the standard safety floor. 

The radio has a built-in voice alarm that will start actively nagging you saying *"Radio Battery Low"* if it drops past this point.

Since it draws very little power compared to the drone, it will take *many* hours of flying to go from $7.7\text{V}$ down to $6.4\text{V}$.
...
A fully charged dron battery will read around 4.2V to 4.35V. 
Land and unplug the battery the moment that number dips down to 3.5V.
{{< /callout >}}
