...
date: 2026-05-11
draft: false
tags: ["JAlcocerTech Brand HUBs","XIRR","Open Design","OpenCode vs Hermes","TradingAgents"]
description: 'Arent you shipping yet? Use CLIs with skills and plugins while getting ready for PostMortems.'
url: 'poc-105'
---
...
There is live beyond claude desktop and [codex app for windows](https://developers.openai.com/codex/app/windows):
...
1. [OpenClaw](https://github.com/openclaw/openclaw) (ex moltbot, ex clawdbot)
...
#No inference provider configured. Run 'hermes model' to choose a provider and model, or set an API key (OPENROUTER_API_KEY, OPENAI_API_KEY, etc.) in ~/.hermes/.env. Falling back to auto provider detection.
source ~/.bashrc
#hermes model
#sudo usermod -aG docker jalcocert && newgrp docker #for the Pi setup
```
...
> You can also have a look to `https://github.com/TauricResearch/TradingAgents` for Multi-Agents LLM Financial Trading Framework
...
{{< callout type="info" >}}
Say you have a [procedural way to analyze PBI](https://github.com/JAlcocerT/PBi/blob/main/procedural.md) dashboards in `.md` - You can make a skill and a plugin
{{< /callout >}}
...
I got to know via https://www.youtube.com/watch?v=utRYkiqGuZI and the intro blog is https://blog.fsck.com/2025/10/09/superpowers/ and latest releases [here](https://blog.fsck.com/agent-blog/2026/03/31/superpowers-v5-0-7/)
...
> Apache v2 | 🎨 Local-first, open-source alternative to Anthropic's Claude Design.

> > 19 Skills · ✨ 71 brand-grade Design Systems 🖼 Generate web · desktop · mobile prototypes · slides · images · videos · HyperFrames 📦 Sandboxed preview · HTML/PDF/PPTX/MP4 export 🤖 Runs on Claude Code / Codex / Cursor / Gemini / OpenCode / Qwen / Copilot / Hermes / Kimi CLI.
...
> [Codex cli](https://developers.openai.com/codex/cli) can now create images, search the web and automate repeatable workflows via the `exec` command *bye n8n :,)*
...
With `Huashu design` you can easily [create a **brand kit**](https://github.com/JAlcocerT/jalcocertech-services/tree/master/design-brand-kit) and generate not only pptx and video.

But also infographic, one pagers...

Or even make a `jalc-portrait-square-refined-1024-v2` around your brand assets.

* https://github.com/JAlcocerT/ebook-ideas/tree/master/z-z-destilled
...
* Docuseal
* it-tools
* Vert - Which uses [WASM](https://jalcocert.github.io/JAlcocerT/wasm/)
* Pairdrop...
