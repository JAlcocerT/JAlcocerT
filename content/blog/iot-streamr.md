---
title: "Streamr - The P2P PubSub Network for IoT"
date: 2025-11-30
draft: false
...
Example Docker command to run the node:
```
docker run -d --restart always -p 32200:32200 -v ~/.streamrDocker:/home/streamr/.streamr --name streamr streamr/node
```
...
[1](https://streamr.network/stake-and-earn)
[2](https://docs.streamr.network/streamr-network/network-roles/operators)
[3](https://www.kucoin.com/price/DATA)
[4](https://streamr.network/network-explorer)
[5](https://x.com/streamr/status/1784964378946638152)
[6](https://www.youtube.com/watch?v=puidkU7zg84)
[7](https://www.youtube.com/watch?v=Qj2ruq5pu5M)
[8](https://coinmarketcap.com/currencies/streamr/)
[9](https://docs.streamr.network/help/operator-faq/)
[10](https://thanhle.blog/en/blog/build-realtime-dashboard-using-centralized-platform-streamr)
[11](https://beincrypto.com/streamr-decentralised-network-data-sharing/)
[12](https://help.runonflux.io/docs/migrate-your-streamr-broker-node-to-the-new-streamr-1-0-testnet-node/)
[13](https://discourse.nodered.org/t/how-can-i-live-stream-on-my-dashboard/27044)
[14](https://x.com/Streamr)
[15](https://www.dune.com/streamr/dashboard)
[16](https://streamr.network)
[17](https://unihost.com/blog/making-money-from-validators-nodes/)
[18](https://coinmarketcap.com/cmc-ai/streamr/what-is/)
[19](https://dev.to/thanhlm/build-realtime-dasboard-using-decentralized-platform-streamr-5djo)
[20](https://depinscan.io/projects/streamr)
...
Streamr shares similarities with MQTT as both use a publish-subscribe messaging pattern to handle real-time data streams, primarily for IoT devices. However, Streamr distinguishes itself by being fully decentralized, blockchain-integrated for payments and governance, and designed for Web3 data streaming ecosystems.

MQTT is centralized and protocol-focused, whereas Streamr combines P2P networking, economic incentives, and cryptographic security in an open data marketplace.[1][3][2]
